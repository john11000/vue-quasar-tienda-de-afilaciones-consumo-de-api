...
export default defineComponent({
  ...
  beforeCreate: async function () {
    ...
    this.productos = res.data.productosTotal.slice(0, this.actual + 7);
    this.productosTotal = res.data.productosTotal;
  ...
  methods: {
    inter: function () {
      this.actual += 7;
      this.productos = this.productosTotal.slice(0, this.actual + 7);
    },
